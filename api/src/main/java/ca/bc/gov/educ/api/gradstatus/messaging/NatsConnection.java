package ca.bc.gov.educ.api.gradstatus.messaging;
...
public class NatsConnection implements Closeable {
   ...
   */
  @Autowired
  public NatsConnection(final EducGradStatusApiConstants applicationProperties) throws IOException, InterruptedException {
  ...
  private Connection connectToNats(String stanUrl, int maxReconnects) throws IOException, InterruptedException {
    io.nats.client.Options natsOptions = new io.nats.client.Options.Builder()
        ...
        .connectionName(EducGradStatusApiConstants.GRAD_STATUS_API)
